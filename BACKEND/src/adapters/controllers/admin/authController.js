...
import recruiterblock from "../../../application/useCase/admin/block&unblockrecruiter.js"
...
import GetalldataCount from "../../../application/useCase/admin/getalldatacount.js"
import Getallgraphdata from "../../../application/useCase/admin/getallgraphdata.js"
...
const authController = (adminAuthRepositoryInt,adminAuthRepositoryImp,authServiceInterface,authServiceImp,userAuthRepositoryInt,userAuthRepositoryImp,recruiterAuthRepositoryInt,recruiterAuthRepositoryImp,jobRepositoryInf,jobRepositoryImp,userprofileRepositoryInt,userprofileRepositoryImp) => {
    ...
    console.log("haiiiiiiiiii");
        GetalldataCount(userdbrepository,recruiterdbrepository,jobdbrepository).then((response)=>{
            console.log(response);
            res.json(response)
